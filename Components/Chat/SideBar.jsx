...
import { MdPaid, Mbsettings, MdClose } from "react-icons/md";

const SideBar = () => {
  return (<nav className='navbar navbar-expand-md p-0'>
    ...
    <div className="collapse navbar-collapse" id="mainnavbarNav">
      <div className='menu-panel'>
        <button className='mainnav-close d-block d-md-none'
          data-bs-toggle="collapse"
          data-bs-target="#mainnavbarNav">
          <MdClose className='icon-custom' />
        </button>
        <a href="/" className='logo-icon d-none d-md-flex'>
          <img src="assets/svg/logo-icon.svg" className='img-fluid' alt="" /></a>
        <ul className='nav nav-tabs menu-wrapper' id='myTab' role='tablist'>
          ...
          <li className='nav-item'
            ...
            <button className='nav-link'
              ...
              aria-selected="true">
              <Mbsettings className='icon-custom' />
              <span>Settings</span>
            </button>
          </li>
        </ul>
